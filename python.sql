...
-- 3) which are the top 5 product with the highest avg review rating?
...
-- 7) segment customer into new returning and loyal base on their total number of previous purchases
...
-- 9) are customer who are repeat buyer(more than 5 previous purchases) also likely to subscribe?
select subscription_status,
